import { Box, Container, Stack, Typography, Card, CardContent, Grid, Avatar } from '@mui/material';
...
const sdData = {
  ...
  '@type': 'AboutPage',
  'name': 'Quem Somos — NPPAvalia',
  'description': 'Conheça a história e os fundadores do NPPAvalia, a plataforma de apoio à rotina clínica de psicopedagogos e neuropsicopedagogos.',
  'url': 'https://nppavalia.com.br/quem-somos',
};
...
export default function AboutUsPage() {
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <PageMeta
        title="Quem Somos | NPPAvalia"
        description="Conheça a história e os fundadores do NPPAvalia. Unindo a experiência clínica em neuropsicopedagogia e a engenharia de software para otimizar processos avaliativos."
      />
        ...
        <Container maxWidth="lg" sx={{ py: 8 }}>
          <Grid container spacing={8}>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <AnimatedSection animation="fadeRight" height="100%">
                <Stack spacing={3}>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <AnimatedSection animation="fadeLeft" height="100%">
                <Card sx={{ bgcolor: 'primary.dark', color: 'primary.contrastText', p: 4, height: '100%', borderRadius: 3, boxShadow: '0 12px 30px rgba(91, 19, 236, 0.15)' }}>
                  <CardContent>
                    <Stack spacing={3}>
            ...
            <Grid size={{ xs: 12 }}>
              <Box sx={{ mt: 6, overflow: 'hidden' }}>
                ...
                <Grid container spacing={4} justifyContent="center">
                  {/* Ana Paula */}
                  <Grid size={{ xs: 12, md: 6 }}>
                    <AnimatedSection animation="fadeRight" delay={150} height="100%">
                      <Card
                        sx={{
                          p: 4,
                          height: '100%',
                  ...
                  {/* Tony Sandro */}
                  <Grid size={{ xs: 12, md: 6 }}>
                    <AnimatedSection animation="fadeLeft" delay={150} height="100%">
                      <Card
                        sx={{
                          p: 4,
                          height: '100%',
