  ...
  return (
    <Box>
      ...
      <main>
                ...
                {resources.map((item) => {
                  ...
                  return (
                    <Grid key={item.title} size={{ xs: 12, sm: 6, md: 3 }}>
                      ...
                      >
                        <CardContent sx={{ p: 3 }}>
                          <Box sx={{ width: 44, height: 44, borderRadius: 2, bgcolor: 'primary.main', display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 2 }}>
        ...
        {/* CTA */}
        <Box component="section" sx={{ py: { xs: 8, md: 10 }, bgcolor: 'background.paper', textAlign: 'center' }}>
