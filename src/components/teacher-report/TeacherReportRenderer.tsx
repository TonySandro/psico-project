...
import type { TeacherReportSchema } from '@/types/teacherReport';
import SectionRenderer from './SectionRenderer';

interface TeacherReportRendererProps {
...
export default function TeacherReportRenderer({
  schema,
  defaultValues = {},
  readOnly = false,
  onValuesChange,
